import type { ReactiveControllerHost } from "lit-element";
...
export class PickingCtrl extends BabylonControllerBase<PickingHost> {
    ...
    init() {
        this.#observers = [this.host.scene.onPointerObservable.add(this.#onpointer), this.host.scene.onMeshRemovedObservable.add(this.#onremove)];
    }
